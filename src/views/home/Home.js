        ...
        return (
            <View style={{ marginTop: 20 }}>
                ...
                {note && index == selectedIndex ?
                    <View style={{ marginLeft: 20, marginRight: 47, paddingBottom: 20, backgroundColor: '#F2F3F7', borderRadius: 5, marginTop: 15 }}>
                        <View style={{ marginTop: 20, marginRight: 20 }}>
                            <Text style={{ color: '#000', fontFamily: "OpenSans-Medium", marginRight: 6, fontSize: 14, marginLeft: 20 }}>צריך לתאם טלפונית עם המרפאה כדי לעשות את החיסון ל-2023</Text>
                        </View>
                ...
                <View style={{ marginLeft: 20, marginRight: 47, marginTop: 15, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }} >
                    ...
                    <View style={{}}>
                        <TouchableOpacity activeOpacity={.3} style={{ flexDirection: 'row', alignItems: 'center', }} onPress={() => setNote(!note)+setSelectedIndex(index)}>
